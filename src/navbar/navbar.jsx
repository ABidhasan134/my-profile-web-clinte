  ...
  return (
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        ...
        <motion.button initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{duration:2}}>
        <Link to="/">
          <img
            src={logImage}
            alt="user image"
            className="w-[50px] h-[50px] rounded-3xl border-2 p-[2px] border-blue-800"
          />
        </Link>
        </motion.button>
      </div>
      ...
      <div className="navbar-end">
        ...
        <motion.button initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{duration:2}}>
          <button
            className="btn hover:border-gray-400 text-2xl"
            onClick={() => document.getElementById("my_modal_1").showModal()}
          >
            Hire me <MdKeyboardDoubleArrowRight></MdKeyboardDoubleArrowRight>
          </button>
        </motion.button>
